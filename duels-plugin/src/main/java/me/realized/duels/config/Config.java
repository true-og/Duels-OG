...
public class Config extends AbstractConfiguration<DuelsPlugin> {
    ...
    @Getter
    private boolean ecPreventDuel;
    @Getter
    private boolean ecPreventTag;
    @Getter
    ...
    @Getter
    private List<String> endCommandsBet;
    @Getter
    private List<String> endCommandsNoBet;
    @Getter
    ...
    protected void loadValues(FileConfiguration configuration) throws Exception {
        ...
        ecPreventDuel = configuration.getBoolean("supported-plugins.EternalCombat.prevent-duel-if-tagged", true);
        ecPreventTag = configuration.getBoolean("supported-plugins.EternalCombat.prevent-tag-in-duel", true);
        ...
        endCommandsBet = configuration.getStringList("duel.match.end-commands.bet-commands");
        endCommandsNoBet = configuration.getStringList("duel.match.end-commands.no-bet-commands");
