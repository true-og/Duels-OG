...
public class ItemBettingButton extends BaseButton {
    ...
    public ItemBettingButton(final DuelsPlugin plugin) {
        super(
                ...
                ItemBuilder.of(Material.DIAMOND)
                        .name(plugin.getLang().getMessage("GUI.settings.buttons.item-betting.name"))
                        .build());
    }
    ...
    public void update(final Player player) {
        if (config.isItemBettingUsePermission()
            ...
            setLore(lang.getMessage("GUI.settings.buttons.item-betting.lore-no-permission")
                    .split("\n"));
            return;
        }
        ...
        final String lore =
                plugin.getLang().getMessage("GUI.settings.buttons.item-betting.lore", "item_betting", itemBetting);
        setLore(lore.split("\n"));
    }
