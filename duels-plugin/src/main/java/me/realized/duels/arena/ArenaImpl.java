...
public class ArenaImpl extends BaseButton implements Arena {
    ...
    public ArenaImpl(final DuelsPlugin plugin, final String name, final boolean disabled) {
        super(
                plugin,
                ItemBuilder.of(Items.EMPTY_MAP)
                        .name(plugin.getLang().getMessage("GUI.arena-selector.buttons.arena.name", "name", name))
                        .lore(plugin.getLang()
                                .getMessage("GUI.arena-selector.buttons.arena.lore-unavailable")
                                .split("\n"))
                        .build());
        this.name = name;
    ...
    public void refreshGui(final boolean available) {
        setLore(lang.getMessage("GUI.arena-selector.buttons.arena.lore-" + (available ? "available" : "unavailable"))
                .split("\n"));
    ...
    public MatchImpl startMatch(
            final KitImpl kit, final Map<UUID, List<ItemStack>> items, final int bet, final Queue source) {
    ...
    public void broadcast(final String message) {
        ...
        spectateManager.getSpectatorsImpl(this).stream()
    ...
    public void onClick(final Player player) {
        ...
        final String kitName =
                settings.getKit() != null ? settings.getKit().getName() : lang.getMessage("GENERAL.none");
    ...
    public void setMatch(MatchImpl match) {
        this.match = match;
    }
