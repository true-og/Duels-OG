...
public final class TextBuilder {
	...
	private TextBuilder(final String base,
		...
		Arrays.stream(TextComponent.fromLegacyText(base)).forEach(component -> {
			...
			if (hoverValue != null) {
				component.setHoverEvent(new HoverEvent(hoverAction, new Text(TextComponent.fromLegacyText(hoverValue))));
			}
	...
	public TextBuilder setHoverEvent(final HoverEvent.Action action, final String value) {
		...
		list.forEach(component -> component.setHoverEvent(new HoverEvent(action, new Text(TextComponent.fromLegacyText(value)))));
		return this;
	}
