...
public class TopCommand extends BaseCommand {
    ...
    public TopCommand(final DuelsPlugin plugin) {
        super(
                ...
                "top",
                "top [-:kit:wins:losses]",
                "Displays top wins, losses, or rating for kit.",
                Permissions.TOP,
                2,
                true);
    }
    ...
    protected void execute(final CommandSender sender, final String label, final String[] args) {
        ...
        lang.sendMessage(
                sender, "COMMAND.duel.top.next-update", "remaining", userManager.getNextUpdate(topEntry.getCreation()));
        ...
        for (int i = 0; i < top.size(); i++) {
            ...
            lang.sendMessage(
                    sender,
                    "COMMAND.duel.top.display-format",
                    "rank",
                    i + 1,
                    "name",
                    data.getName(),
