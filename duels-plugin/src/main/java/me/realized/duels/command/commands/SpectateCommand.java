    ...
    protected void execute(final CommandSender sender, final String label, final String[] args) {
        ...
        switch (result) {
            ...
            case SUCCESS:
                ...
                // Meaningless checks to halt IDE warnings as target is guaranteed to be in a match if result is
                // SUCCESS.
                ...
                lang.sendMessage(
                        player,
                        "COMMAND.spectate.start-spectate",
                        "name",
                        target.getName(),
                        "opponent",
                        arena.getOpponent(target).getName(),
                        "kit",
                        kit,
                        "arena",
                        arena.getName(),
